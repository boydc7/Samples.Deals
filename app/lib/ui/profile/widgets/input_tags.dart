...
class ProfileInputTags extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Tag> _tags = List<Tag>.from(tagsConfig.tagsPublishers);

    /// add any existing tags on the model that are not in our config
    ...
    return WorkspaceFeatures.hasBusinessTags(
