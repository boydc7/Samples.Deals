...
import 'package:rydr_app/ui/shared/blocs/buttons.dart';
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: IconButton(
          ...
          onPressed: onPressed != null
              ? onPressed
              : () {
                  /// in some instances we may not have a stack to pop back to
                  /// one instance is when got sent to a page from a native push notification
                  if (Navigator.of(context).canPop()) {
                    ...
                    if (appState.currentProfile == null) {
                      Navigator.of(context)
                          .pushNamed(AppRouting.getConnectPages);
                    } else {
                      /// if we're unable to pop then send user to the right homepage
                      /// based on whether they are a business or an influencer
                      Navigator.of(context)
                          .pushNamed(appState.getInitialRoute());
                    }
                  }
                },
        ),
              ...
              child: Stack(
                ...
                children: <Widget>[
                  Transform.scale(
                    ...
                    child: ClipRRect(
                      borderRadius:
                          BorderRadius.circular(widget.round ? 32 : 8),
