...
namespace Rydr.Api.Dto.Enums
{
    ...
    {
        public static HashSet<string> PendingDealRequestStatuses { get; } = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                                            {
        ...
        public static HashSet<DealRequestStatus> CompletableDealRequestStatuses { get; } = new HashSet<DealRequestStatus>
                                                                                           {
