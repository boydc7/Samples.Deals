...
namespace Rydr.Api.Core.Extensions
{
    ...
    {
        public static readonly HashSet<string> RydrSystemPublisherAccountIds = new HashSet<string>(StringComparer.Ordinal)
                                                                               {
                ...
                _deferRequestsService.PublishMessage(new PostDeferredAffected
                                                     {
                                                         CompositeIds = new List<DynamoItemIdEdge>
                                                                        {
                                                                            new DynamoItemIdEdge(dailyStat.Id, dailyStat.EdgeId)
                                                                        },
                                                         Type = statRecordType
                                                     });
            }
