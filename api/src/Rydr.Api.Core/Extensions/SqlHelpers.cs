...
namespace Rydr.Api.Core.Extensions
{
    public static class SqlHelpers
    {
        ...
        private static readonly ConcurrentDictionary<string, PropertyInfo> _propertyNameMap = new ConcurrentDictionary<string, PropertyInfo>();
        private static readonly ConcurrentDictionary<PropertyInfo, string> _propertyInfoAliasMap = new ConcurrentDictionary<PropertyInfo, string>();
