...
{
    private static readonly ConcurrentDictionary<string, bool> _implementsInterfaceMap = new();
    private static readonly ConcurrentDictionary<string, List<PropertyInfo>> _typePropertyMap = new();
    private static readonly ConcurrentDictionary<TypeMethodAttribute, Attribute[]> _typeMethodAttributeMap = new();
