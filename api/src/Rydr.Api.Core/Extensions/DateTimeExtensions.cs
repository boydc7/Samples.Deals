...
public static class DateTimeExtensions
{
    ...
    public static DateTime ToDateTimeKind(this DateTime dateTime, DateTimeKind toKind) => new(dateTime.Ticks, toKind);
    ...
    public static DateTime StartOfMonth(this DateTime source)
        => new(source.Year, source.Month, 1, 0, 0, 0, source.Kind);
}
