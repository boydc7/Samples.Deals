...
{
    private static readonly List<IUserAuthDetails> _emptyAuthDetails = [];
    ...
    public IUserAuth GetUserAuth(string userAuthId)
        => GetDynUser(userAuthId.ToLong(0));
    ...
    {
        var userId = userAuthId.ToLong(0);
    ...
    {
        var userIdLong = userId.ToLong(0);
    ...
    public void StoreAll(IEnumerable<ApiKey> apiKeys)
    {
        ...
        {
            var userId = apiKey.UserAuthId.ToLong(0);
    ...
    private RydrUserSession ToRydrUserSession(IAuthSession authSession)
    {
        ...
        var dynUser = _userService.TryGetUser(rydrAuthSession.UserId.Gz(rydrAuthSession.UserAuthId.ToLong(0)), true);
