...
namespace Rydr.Api.Core.Models.Internal
{
    public class AuthorizerResult
    {
        ...
        public static readonly AuthorizerResult Unspecified = new AuthorizerResult
                                                              {
        ...
        public static readonly AuthorizerResult ExplicitlyAuthorized = new AuthorizerResult
                                                                       {
                                                                           FailLevel = AuthorizerFailLevel.ExplicitlyAuthorized
                                                                       };

        public static readonly AuthorizerResult ExplicitRead = new AuthorizerResult
                                                               {
        ...
        public static AuthorizerResult Unauthorized(string message) => new AuthorizerResult
                                                                       {
        ...
        public static AuthorizerResult InvalidData(string message) => new AuthorizerResult
                                                                      {
                                                                          FailLevel = AuthorizerFailLevel.Unauthorized,
