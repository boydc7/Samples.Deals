...
namespace Rydr.Api.Core.Interfaces.DataAccess
{
    ...
    public interface IRdbmsDataService : IDataService
    {
        ...
        Task UpdateOnlyAsync<T, TIdType>(T partialModel, Expression<Func<T, object>> theseFields,
        ...
        void UpdateOnly<T, TIdType>(T partialModel, Expression<Func<T, object>> theseFields,
                                    Func<IDbConnection, SqlExpression<T>> selectFilter,
                                    Func<IEnumerable<T>, Expression<Func<T, bool>>> updateFilter,
                                    Func<T, TIdType> idResolver);
