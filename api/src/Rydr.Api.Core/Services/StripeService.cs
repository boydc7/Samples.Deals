...
public class StripeService
{
    ...
    private static readonly List<string> _invoiceExpandList = new()
                                                              {
                                                                  "lines"
                                                              };

    private static readonly List<string> _subscriptionExpandList = new()
                                                                   {
                                                                       "plan",
                                                                       "customer",
                                                                       "items"
    ...
    private static readonly List<string> _setupIntentExpandList = new()
                                                                  {
                                                                      "payment_method"
                                                                  };

    private static readonly List<string> _defaultPaymentMethodTypes = new()
                                                                      {
                                                                          "card"
                                                                      };

    private static readonly List<string> _subscriptionItemExpandList = new()
                                                                       {
                                                                           "data.plan"
                                                                       };
                                                          ...
                                                          string planId = null, string existingSubscriptionId = null)
    {
        ...
        else
        {
            ...
            opts.LineItems = new List<SessionLineItemOptions>
                             {
                                 new()
                                 {
                                     Price = planId.Coalesce(_subscriptionPlanService.PayPerBusinessPlanId),
