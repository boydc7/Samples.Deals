...
namespace Rydr.Api.Core.Services.Internal
{
    public class LocalResourceManager
    {
        ...
        private static readonly object _cacheMaintainLockItem = new object();
        private static long _resourcesLastMaintained;
        private static bool _processing;

        private readonly ConcurrentDictionary<Type, DefaultTaskInfo> _typeCallbackMap = new ConcurrentDictionary<Type, DefaultTaskInfo>();

        private LocalResourceManager() { }

        public static LocalResourceManager Instance { get; } = new LocalResourceManager();
