...
namespace Rydr.Api.Core.Services.Internal
{
    public static class DateTimeHelper
    {
        ...
        public static readonly DateTime MinApplicationDate = new DateTime(2002, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        public static readonly DateTime MaxApplicationDate = new DateTime(2060, 12, 31, 0, 0, 0, DateTimeKind.Utc);
