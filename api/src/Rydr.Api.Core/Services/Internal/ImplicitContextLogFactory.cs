    ...
    public class ImplicitContextLog : ILog
    {
        ...
        public void Error(object message, Exception exception)
        {
            ...
            var msg = msgString.StartsWithOrdinalCi("!!! ")
                          ? msgString
                          : exception?.ToLogMessage(wasHandled: true, customMessage: msgString) ?? msgString;
        ...
        {
            var msg = exception?.ToLogMessage(wasHandled: true, customMessage: message.ToString()) ?? message?.ToString();
