...
namespace Rydr.Api.Core.Services.Internal
{
    ...
    {
        private readonly ConcurrentDictionary<string, long> _sequenceMap = new ConcurrentDictionary<string, long>(StringComparer.OrdinalIgnoreCase);
    ...
    {
        private readonly ConcurrentDictionary<string, long> _maxLocalMap = new ConcurrentDictionary<string, long>(StringComparer.OrdinalIgnoreCase);
        private readonly ConcurrentDictionary<string, long> _minUsedMap = new ConcurrentDictionary<string, long>(StringComparer.OrdinalIgnoreCase);
