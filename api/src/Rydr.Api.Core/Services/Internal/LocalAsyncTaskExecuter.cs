...
namespace Rydr.Api.Core.Services.Internal
{
    public class LocalAsyncTaskExecuter : LocalAsyncProducer<ITaskInfo>, ITaskExecuter, ITaskProducer
    {
        ...
        public static LocalAsyncTaskExecuter DefaultTaskExecuter { get; } = new LocalAsyncTaskExecuter(InMemoryTaskBuffer.Default, isDefault: true);
        ...
        public static LocalAsyncTaskExecuter Create(int maxDop) => new LocalAsyncTaskExecuter(InMemoryTaskBuffer.Create, maxDop);
