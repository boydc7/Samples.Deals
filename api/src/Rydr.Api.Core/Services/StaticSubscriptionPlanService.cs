...
public class StaticSubscriptionPlanService : ISubscriptionPlanService
{
    ...
    private readonly Dictionary<string, SubscriptionType> _subscriptionPlanTypeMap = new(StringComparer.OrdinalIgnoreCase);
    ...
    public static StaticSubscriptionPlanService Instance { get; } = new();
