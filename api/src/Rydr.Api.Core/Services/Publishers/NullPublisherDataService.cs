...
namespace Rydr.Api.Core.Services.Publishers
{
    ...
    {
        private static readonly DynPublisherApp _nullPublisherApp = new DynPublisherApp
                                                                    {
        ...
        public static NullPublisherDataService Instance { get; } = new NullPublisherDataService();
