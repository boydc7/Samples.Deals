...
{
    public static readonly HashSet<Type> AllowedAnonRequestTypes = new()
                                                                   {
                                                                       typeof(NoRoute),
                                                                       typeof(Monitor),
                                                                       typeof(Authenticate),
    ...
    public static readonly HashSet<Type> RequestsThatSkipDecoration = new()
                                                                      {
                                                                          typeof(NoRoute),
                                                                          typeof(Monitor),
                                                                          typeof(Authenticate),
    ...
    public static readonly HashSet<Type> RequestsThatSkipLogging = new()
                                                                   {
                                                                       typeof(Monitor),
                                                                       typeof(RequestLogs),
                                                                       typeof(PutWorkspaceAccountLocation),
    ...
    public static readonly HashSet<string> WriteableHttpVerbs = new(StringComparer.OrdinalIgnoreCase)
                                                                {
                                                                    "POST",
                                                                    "PUT",
                                                                    "DELETE"
        ...
        state.ContextPublisherAccountId = requestDto switch
                                          {
                                              ...
                                              IHasPublisherAccountIdentifier rdpaif => rdpaif.PublisherIdentifier.ToLong(0),
