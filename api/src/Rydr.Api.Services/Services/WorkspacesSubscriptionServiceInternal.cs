            ...
            _deferRequestsService.PublishMessage(new PostDeferredAffected
                                                 {
                                                     CompositeIds = new List<DynamoItemIdEdge>
                                                                    {
                                                                        new DynamoItemIdEdge(workspaceSubscription.SubscriptionWorkspaceId, workspaceSubscription.EdgeId)
                                                                    },
            ...
            _deferRequestsService.PublishMessage(new PostDeferredAffected
                                                 {
                                                     CompositeIds = new List<DynamoItemIdEdge>
                                                                    {
                                                                        new DynamoItemIdEdge(request.SubscriptionWorkspaceId, DynWorkspacePublisherSubscription.BuildEdgeId(request.PublisherAccountId))
                                                                    },
            ...
            _deferRequestsService.PublishMessage(new PostDeferredAffected
                                                 {
                                                     CompositeIds = new List<DynamoItemIdEdge>
                                                                    {
                                                                        new DynamoItemIdEdge(workspace.Id, workspaceSubscription.EdgeId)
                                                                    },
                                                     Type = RecordType.WorkspaceSubscription
                                                 });
        }
