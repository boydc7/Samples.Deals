...
#pragma warning restore 162
    ...
    private static DynItemValidationSource ToDynItemValidationSource(this IRequestBase request, long id, string edgeId, DynItemType type, string referenceId = null, ApplyToBehavior treatLike = ApplyToBehavior.Default, bool skipAccessChecks = false)
        => new(request, id, edgeId, type, referenceId, treatLike, skipAccessChecks);
