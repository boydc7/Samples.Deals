...
namespace Rydr.FbSdk.Enums
{
    ...
    {
        private static readonly HashSet<long> _accessTokenRefreshRequiredCodes = new HashSet<long>
                                                                                 {
                                                                                     190,
                                                                                     102
                                                                                 };

        private static readonly HashSet<long> _accessTokenRefreshRequiredSubCodes = new HashSet<long>
                                                                                    {
                                                                                        458,
                                                                                        459,
                                                                                        460,
        ...
        private static readonly HashSet<long> _permissionErrorCodes = new HashSet<long>
                                                                      {
                                                                          33,
                                                                          100,
                                                                          2018001,
