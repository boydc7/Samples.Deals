...
namespace Rydr.FbSdk.Enums
{
    public static class FbIgInsights
    {
        ...
        public static readonly HashSet<string> EngageStatNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                                 {
                                                                     "engagement",
        ...
        public static readonly HashSet<string> SaveStatNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                               {
                                                                   "saved",
                                                                   "carousel_album_saved"
                                                               };

        public static readonly HashSet<string> ViewStatNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                               {
                                                                   "video_views",
                                                                   "carousel_album_video_views"
                                                               };

        public static readonly HashSet<string> ReachStatNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                                {
                                                                    "reach",
                                                                    "carousel_album_reach"
                                                                };

        public static readonly HashSet<string> ImpressionStatNames = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                                                                     {
                                                                         "impressions",
