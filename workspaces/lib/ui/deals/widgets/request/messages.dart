...
import 'package:rydrworkspaces/models/dialog_message.dart';
...
class DealMessages extends StatelessWidget {
  ...
  void goToDialog(BuildContext context, bool autofocus) => null;
...
/*
  ...
  Widget build(BuildContext context) {
    ...
    if (status == DealRequestStatus.invited ||
      ...
      messageSubtitle =
          "You will be able to direct message ${deal.request.publisherAccount.userName} if this ${isInvite ? "invite" : "request"} is ${isInvite ? "accepted" : "approved"}.";
    }
